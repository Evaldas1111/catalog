    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
                <form action="" class="tm-text-primary">
                    Puslapis <input type="text" value="<?=$data['page_current']?>" size="1" class="tm-input-paging tm-text-primary"> of <?=$data['page_total']?>
                </form>
            </div>
        </div>
        ...
        <div class="row tm-mb-90">
            <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
                <a href="<?=$data['page_prev']?>" class="btn btn-primary tm-btn-prev mb-2 ">Ankstesnė</a>
                ...
                <a href="<?=$data['page_next']?>" class="btn btn-primary tm-btn-next">Kitas puslapis</a>
            </div>            
        </div>
